    ...
    <div className="max-w-2xl">
      ...
      {activeTab === 'write' ? (
        ...
        <div>
          ...
          <textarea className="input-field w-full min-h-[240px] resize-y font-mono text-sm" value={content} onChange={(e) => setContent(e.target.value)} placeholder="Write your post..." />
